document.addEventListener('DOMContentLoaded', () => {
    const { showResult, runSection } = window.BrowserTester;

    // Test input types
    const inputTests = document.getElementById('inputTests');
    runSection('Input Types', inputTests, () => {
        const inputTypes = [
            'color',
            'date',
            'datetime-local',
    ...
    runSection('Form Features', formFeatureTests, () => {
        // Test autocomplete
    ...
    runSection('Validation', validationTests, () => {
